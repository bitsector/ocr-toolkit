...
class DetectedLanguage(BaseModel):
    ...
    confidence: float = Field(
        ..., ge=0.0, le=1.0, description="Confidence score for this language detection"
    )
    text_percentage: float = Field(
        ..., ge=0.0, le=100.0, description="Percentage of text in this language"
    )
